...
export const metadata: Metadata = {
  title: "HoopZone Basketball Academy - Elite Training Programs",
  description: "Master your basketball skills with professional training programs. Expert coaches, proven results, and comprehensive development for players of all levels.",
  keywords: "basketball training, basketball academy, basketball coach, basketball skills, basketball programs",
  openGraph: {
    title: "HoopZone Basketball Academy - Elite Training Programs",
    description: "Master your basketball skills with professional training programs. Expert coaches, proven results, and comprehensive development for players of all levels.",
    siteName: "HoopZone Basketball Academy",
    type: "website",
    images: [{ url: "/placeholders/placeholder1.webp", alt: "HoopZone Basketball Training" }]
  },
  twitter: {
    card: "summary_large_image",
    title: "HoopZone Basketball Academy - Elite Training Programs",
    description: "Master your basketball skills with professional training programs. Expert coaches, proven results, and comprehensive development for players of all levels.",
    images: ["/placeholders/placeholder1.webp"]
  },
  robots: {
    index: true,
    follow: true
